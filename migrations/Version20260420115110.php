...
final class Version20260420115110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, effect_value INT NOT NULL, description VARCHAR(500) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE pet (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, species VARCHAR(255) NOT NULL, level INT NOT NULL, xp INT NOT NULL, xp_to_next_level INT NOT NULL, hunger INT NOT NULL, happiness INT NOT NULL, health INT NOT NULL, energy INT NOT NULL, last_interacted_at DATETIME DEFAULT NULL, born_at DATETIME NOT NULL, last_stats_degradation_at DATETIME DEFAULT NULL, is_alive TINYINT NOT NULL, owner_id INT NOT NULL, INDEX IDX_E4529B857E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql("INSERT INTO item (name, type, effect_value, description) VALUES 
            ('Dog Food', 'food', 20, 'Nutritious dog food that restores hunger'),
            ('Toy Ball', 'toy', 10, 'A fun ball toy that increases happiness'),
            ('Antibiotic Cream', 'medicine', 30, 'Heals minor wounds and health issues')
        ");
    }
